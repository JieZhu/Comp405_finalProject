...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "finalproject" because\n';
  ...
  $wnd.__gwt_activeModules['finalproject'] = {
 ...
 * "/finalproject.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['finalproject'].superdevmode = true;

  var expectedSuffix = '/finalproject.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + finalproject + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:finalproject';
  var devModeSessionKey = '__gwtDevModeSession:finalproject';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/finalproject/finalproject.nocache.js';
  ...
  $wnd.__gwt_activeModules['finalproject'].canRedirect = true;
  $wnd.__gwt_activeModules['finalproject'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING finalproject';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/finalproject?user.agent=' + ua + '&_callback=' + callback;
